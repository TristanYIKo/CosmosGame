...
public class GamePanel extends JPanel implements Runnable {
    ...
    private void setupGameOverPanel() {
        ...
        menuButton.setPreferredSize(new Dimension(300, 80)); // Set button size to 300x80
        ...
        retryButton.setPreferredSize(new Dimension(300, 80)); // Set button size to 300x80
    ...
    private class Trail {
        ...
        private int age;
        private static final double ANGLE = Math.toRadians(45); // Rotation angle in radians
